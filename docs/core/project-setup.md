...
- **`pnpm` recomendado.** Si no está instalado, ver Regla 0 en [agent-instructions.md](./agent-instructions.md).
...
ℹ️ **SafeAreaProvider** envuelve toda la app en un solo alto para que todas las screens respeten el safe area del dispositivo (status bar, notch, dynamic island). Luego cada screen usa individualmente `<SafeAreaView>` (ver [conventions.md](./conventions.md) para la convención).
...
> Siguientes pasos: [structure-guide.md](./structure-guide.md) → [navigation-patterns.md](./navigation-patterns.md) → [templates-snippets.md](./templates-snippets.md)

...
1. **[docs/core/project-setup.md](docs/core/project-setup.md)** — Read the ENTIRE file. It contains:
...
2. **[docs/core/nativewind-theme.md](docs/core/nativewind-theme.md)** — Read the "Configuracion `tailwind.config.js`" section for the complete Tailwind config with custom colors and spacing.
...
Then align the runtime to the stable SDK line documented in [docs/core/project-setup.md](docs/core/project-setup.md) before the first start. Do NOT leave the project on `expo@latest` or any `@latest` template line if Expo Go compatibility matters.
...
- Create `tsconfig.json` with the exact content from [docs/core/project-setup.md](docs/core/project-setup.md) Step 2:
...
Follow the install commands from [docs/core/project-setup.md](docs/core/project-setup.md) Step 3. Do NOT skip any package.
...
Then replace `tailwind.config.js` content with the exact config from [docs/core/project-setup.md](docs/core/project-setup.md) Step 4 (which matches [docs/core/nativewind-theme.md](docs/core/nativewind-theme.md)). Must include:
...
Create `babel.config.js` with the exact content from [docs/core/project-setup.md](docs/core/project-setup.md) Step 5:
...
Create the files from [docs/core/project-setup.md](docs/core/project-setup.md):
...
Create `.env.example` with the content from [docs/core/project-setup.md](docs/core/project-setup.md) Step 8.
Copy to `.env`.

...
1. **[docs/core/structure-guide.md](docs/core/structure-guide.md)** — Read the section "Checklist de Validación Completo" for the full validation checklist (~30 items across all categories).

2. **[docs/core/testing-ci.md](docs/core/testing-ci.md)** — Read the sections:
...
Go through the COMPLETE checklist from [docs/core/structure-guide.md](docs/core/structure-guide.md) section "Checklist de Validación Completo". Check EVERY item:
...
Read [docs/core/testing-ci.md](docs/core/testing-ci.md) section "Instalación" and run:
```bash
...
Copy the exact config from [docs/core/testing-ci.md](docs/core/testing-ci.md):
- `preset: 'jest-expo'`
...
Copy from [docs/core/testing-ci.md](docs/core/testing-ci.md) section "Unit test — Zustand store":
...
Copy from [docs/core/testing-ci.md](docs/core/testing-ci.md) section "Mock de service":

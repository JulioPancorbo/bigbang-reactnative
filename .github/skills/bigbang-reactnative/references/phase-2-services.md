...
1. **[docs/core/services-and-api.md](docs/core/services-and-api.md)** — Read the ENTIRE file. It contains the complete code for:
...
Copy the COMPLETE code from [docs/core/services-and-api.md](docs/core/services-and-api.md):
...
Copy the COMPLETE code from [docs/core/services-and-api.md](docs/core/services-and-api.md) section `auth.ts`:
- `LoginPayload` type
- `AuthResponse` type
...
Copy the exact code from [docs/core/services-and-api.md](docs/core/services-and-api.md) section `storage.ts`:
...
Copy the code from [docs/core/services-and-api.md](docs/core/services-and-api.md) section `logger.ts`:

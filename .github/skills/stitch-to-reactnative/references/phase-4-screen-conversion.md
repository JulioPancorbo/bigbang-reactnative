...
- `docs/templates-snippets.md` — Screen template patterns
- `docs/conventions.md` — Naming, imports, file structure
- `docs/hooks-and-state.md` — Hook patterns, useFormState, React Query

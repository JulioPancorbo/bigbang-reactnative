...
- [docs/core/navigation-patterns.md](docs/core/navigation-patterns.md) — Navigation architecture and patterns
- [docs/core/templates-snippets.md](docs/core/templates-snippets.md) — Stack/Tab registration templates
